...
public class AspUser : IdentityUser, IAggregationRoot
{
    ...
    [StringLength(50)]
    public string? username { get; set; } // Unique username for public profile
    [StringLength(50)]
    public string? slug { get; set; } // URL-friendly slug
    public bool is_public { get; set; } = true; // Portfolio visibility
    public int username_changed_count { get; set; } = 0; // Count of username changes
    public DateTime? last_username_change_date { get; set; } // Last username change date
