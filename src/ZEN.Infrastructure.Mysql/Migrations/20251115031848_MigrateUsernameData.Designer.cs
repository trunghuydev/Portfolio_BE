...
namespace ZEN.Infrastructure.Mysql.Migrations
{
    ...
    [Migration("20251115031848_MigrateUsernameData")]
    partial class MigrateUsernameData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZEN.Domain.Entities.AspUser", b =>
                {
                    ...
                    b.Property<DateTime?>("last_username_change_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("username_changed_count")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZEN.Domain.Entities.Identities.Project", b =>
                {
                    ...
                    b.Property<string>("url_contract")
                        .HasColumnType("text");

                    b.Property<string>("url_demo")
                        .HasColumnType("text");

                    b.Property<string>("url_excel")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ZEN.Domain.Entities.Identities.MyTask", b =>
                {
                    b.HasOne("ZEN.Domain.Entities.Identities.WorkExperience", "WorkExperience")
                        .WithMany("MyTasks")
                        .HasForeignKey("we_id");
